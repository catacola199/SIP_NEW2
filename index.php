...
<body>
         ...
         <div class="container-fluid">
            <div class="row align-items-center">
               <div class="col-xl-3 col-lg-3">
                  <div class="tp-logo">
                     <a href="index.php"><img src="assets/img/logo/logo2.png" alt="" class="img-fluid"></a>
                  </div>
               </div>
   ...
   <?php include 'component/_btn-top-bar.php'; ?>
            ...
            <div class="tp-brand-slider-section">
               <div class="swiper-container brand-slider-active">
                  <div class="swiper-wrapper d-flex align-items-center">
                     ...
                     <div class="swiper-slide">
                        <div class="tp-brand-icon text-center">
                           <img src="assets/img/brand/client2.png" alt="">
                        </div>
                     </div>
                     <div class="swiper-slide">
                        <div class="tp-brand-icon text-center">
   ...
   <!-- JS here -->
   <?php include 'component/js-script.php'; ?>
</body>
